...
void MatrixDivider::div(MatrixData* C, const MatrixData* const A, const MatrixData* const B, bool A_T, bool B_T)
{
...
void MatrixDivider::div(MatrixData* C, const MatrixData* const A, const float alpha)
{
	for(i32 i=0; i<C->m_lines; i+= C->blockHeight()) 
	{
		for(i32 j=0; j<C->m_columns; j+= C->blockWidth()) 
