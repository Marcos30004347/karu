...
{
 return (c[0]*d[3]*std::sin(a[0])*std::cos(a[1]) - c[0]*d[3]*std::sin(a[1])*std::cos(a[0]) - c[0]*d[6]*p21[0]*std::sin(a[0])*std::sin(a[1]) + c[0]*d[6]*p21[1]*std::sin(a[1])*std::cos(a[0]) + c[0]*d[6]*p22[0]*std::sin(a[0])*std::sin(a[1]) - c[0]*d[6]*p22[1]*std::sin(a[0])*std::cos(a[1]) - c[3]*d[0]*std::sin(a[0])*std::cos(a[1]) + c[3]*d[0]*std::sin(a[1])*std::cos(a[0]) + c[3]*d[6]*p21[0]*std::sin(a[0])*std::cos(a[1]) - c[3]*d[6]*p21[1]*std::cos(a[0])*std::cos(a[1]) - c[3]*d[6]*p22[0]*std::sin(a[1])*std::cos(a[0]) + c[3]*d[6]*p22[1]*std::cos(a[0])*std::cos(a[1]) + c[6]*d[0]*p21[0]*std::sin(a[0])*std::sin(a[1]) - c[6]*d[0]*p21[1]*std::sin(a[1])*std::cos(a[0]) - c[6]*d[0]*p22[0]*std::sin(a[0])*std::sin(a[1]) + c[6]*d[0]*p22[1]*std::sin(a[0])*std::cos(a[1]) - c[6]*d[3]*p21[0]*std::sin(a[0])*std::cos(a[1]) + c[6]*d[3]*p21[1]*std::cos(a[0])*std::cos(a[1]) + c[6]*d[3]*p22[0]*std::sin(a[1])*std::cos(a[0]) - c[6]*d[3]*p22[1]*std::cos(a[0])*std::cos(a[1]))/(b[0]*c[3]*std::sin(a[0])*std::cos(a[1]) - b[0]*c[3]*std::sin(a[1])*std::cos(a[0]) - b[0]*c[6]*p21[0]*std::sin(a[0])*std::sin(a[1]) + b[0]*c[6]*p21[1]*std::sin(a[1])*std::cos(a[0]) + b[0]*c[6]*p22[0]*std::sin(a[0])*std::sin(a[1]) + b[0]*c[6]*p22[1]*std::sin(a[0])*std::cos(a[1]) - b[3]*c[0]*std::sin(a[0])*std::cos(a[1]) + b[3]*c[0]*std::sin(a[1])*std::cos(a[0]) + b[3]*c[6]*p21[0]*std::sin(a[0])*std::cos(a[1]) - b[3]*c[6]*p21[1]*std::cos(a[0])*std::cos(a[1]) - b[3]*c[6]*p22[0]*std::sin(a[1])*std::cos(a[0]) + b[3]*c[6]*p22[1]*std::cos(a[0])*std::cos(a[1]) + b[6]*c[0]*p21[0]*std::sin(a[0])*std::sin(a[1]) - b[6]*c[0]*p21[1]*std::sin(a[1])*std::cos(a[0]) - b[6]*c[0]*p22[0]*std::sin(a[0])*std::sin(a[1]) + b[6]*c[0]*p22[1]*std::sin(a[0])*std::cos(a[1]) - b[6]*c[3]*p21[0]*std::sin(a[0])*std::cos(a[1]) + b[6]*c[3]*p21[1]*std::cos(a[0])*std::cos(a[1]) + b[6]*c[3]*p22[0]*std::sin(a[1])*std::cos(a[0]) - b[6]*c[3]*p22[1]*std::cos(a[0])*std::cos(a[1]));
}

double gamma(double* b, double* c, double* d, double* p11, double* p21, double* p12, double* p22, double* a)
{
 return (-b[0]*d[3]*std::sin(a[0])*std::cos(a[1]) + b[0]*d[3]*std::sin(a[1])*std::cos(a[0]) + b[0]*d[6]*p21[0]*std::sin(a[0])*std::sin(a[1]) - b[0]*d[6]*p21[1]*std::sin(a[1])*std::cos(a[0]) - b[0]*d[6]*p22[0]*std::sin(a[0])*std::sin(a[1]) + b[0]*d[6]*p22[1]*std::sin(a[0])*std::cos(a[1]) + b[3]*d[0]*std::sin(a[0])*std::cos(a[1]) - b[3]*d[0]*std::sin(a[1])*std::cos(a[0]) - b[3]*d[6]*p21[0]*std::sin(a[0])*std::cos(a[1]) + b[3]*d[6]*p21[1]*std::cos(a[0])*std::cos(a[1]) + b[3]*d[6]*p22[0]*std::sin(a[1])*std::cos(a[0]) - b[3]*d[6]*p22[1]*std::cos(a[0])*std::cos(a[1]) - b[6]*d[0]*p21[0]*std::sin(a[0])*std::sin(a[1]) + b[6]*d[0]*p21[1]*std::sin(a[1])*std::cos(a[0]) + b[6]*d[0]*p22[0]*std::sin(a[0])*std::sin(a[1]) - b[6]*d[0]*p22[1]*std::sin(a[0])*std::cos(a[1]) + b[6]*d[3]*p21[0]*std::sin(a[0])*std::cos(a[1]) - b[6]*d[3]*p21[1]*std::cos(a[0])*std::cos(a[1]) - b[6]*d[3]*p22[0]*std::sin(a[1])*std::cos(a[0]) + b[6]*d[3]*p22[1]*std::cos(a[0])*std::cos(a[1]))/(b[0]*c[3]*std::sin(a[0])*std::cos(a[1]) - b[0]*c[3]*std::sin(a[1])*std::cos(a[0]) - b[0]*c[6]*p21[0]*std::sin(a[0])*std::sin(a[1]) + b[0]*c[6]*p21[1]*std::sin(a[1])*std::cos(a[0]) + b[0]*c[6]*p22[0]*std::sin(a[0])*std::sin(a[1]) - b[0]*c[6]*p22[1]*std::sin(a[0])*std::cos(a[1]) - b[3]*c[0]*std::sin(a[0])*std::cos(a[1]) + b[3]*c[0]*std::sin(a[1])*std::cos(a[0]) + b[3]*c[6]*p21[0]*std::sin(a[0])*std::cos(a[1]) - b[3]*c[6]*p21[1]*std::cos(a[0])*std::cos(a[1]) - b[3]*c[6]*p22[0]*std::sin(a[1])*std::cos(a[0]) + b[3]*c[6]*p22[1]*std::cos(a[0])*std::cos(a[1]) + b[6]*c[0]*p21[0]*std::sin(a[0])*std::sin(a[1]) - b[6]*c[0]*p21[1]*std::sin(a[1])*std::cos(a[0]) - b[6]*c[0]*p22[0]*std::sin(a[0])*std::sin(a[1]) + b[6]*c[0]*p22[1]*std::sin(a[0])*std::cos(a[1]) - b[6]*c[3]*p21[0]*std::sin(a[0])*std::cos(a[1]) + b[6]*c[3]*p21[1]*std::cos(a[0])*std::cos(a[1]) + b[6]*c[3]*p22[0]*std::sin(a[1])*std::cos(a[0]) - b[6]*c[3]*p22[1]*std::cos(a[0])*std::cos(a[1]));
}
