...
Matrix eightPointAlgorithm(Matrix image0[8], Matrix image1[8])
{
	...
	// 	p_[1][0][0]*p[1][0][0], p_[1][0][0]*p[1][1][0], p_[1][0][0], p_[1][1][0]*p[1][0][0], p_[1][1][0]*p[1][1][0], p_[1][1][0], p[1][0][0], p[1][1][0], 1,
	// 	p_[2][0][0]*p[2][0][0], p_[2][0][0]*p[2][1][0], p_[2][0][0], p_[2][1][0]*p[2][0][0], p_[2][1][0]*p[2][1][0], p_[2][1][0], p[2][0][0], p[2][1][0], 1,
	// 	p_[3][0][0]*p[3][0][0], p_[3][0][0]*p[3][1][0], p_[3][0][0], p_[3][1][0]*p[3][0][0], p_[3][1][0]*p[3][1][0], p_[3][1][0], p[3][0][0], p[3][1][0], 1,
	// 	p_[4][0][0]*p[4][0][0], p_[4][0][0]*p[4][1][0], p_[4][0][0], p_[4][1][0]*p[4][0][0], p_[4][1][0]*p[4][1][0], p_[4][1][0], p[4][0][0], p[4][1][0], 1,
	// 	p_[5][0][0]*p[5][0][0], p_[5][0][0]*p[5][1][0], p_[5][0][0], p_[5][1][0]*p[5][0][0], p_[5][1][0]*p[5][1][0], p_[5][1][0], p[5][0][0], p[5][1][0], 1,
	// 	p_[6][0][0]*p[6][0][0], p_[6][0][0]*p[6][1][0], p_[6][0][0], p_[6][1][0]*p[6][0][0], p_[6][1][0]*p[6][1][0], p_[6][1][0], p[6][0][0], p[6][1][0], 1,
	// 	p_[7][0][0]*p[7][0][0], p_[7][0][0]*p[7][1][0], p_[7][0][0], p_[7][1][0]*p[7][0][0], p_[7][1][0]*p[7][1][0], p_[7][1][0], p[7][0][0], p[7][1][0], 1,
	// });


	Matrix A(8, 9, {
		p[0][0][0]*p_[0][0][0], p[0][0][0]*p_[0][1][0], p[0][0][0], p[0][1][0]*p_[0][0][0], p[0][1][0]*p_[0][1][0], p[0][1][0], p_[0][0][0], p_[0][1][0], 1,
		p[1][0][0]*p_[1][0][0], p[1][0][0]*p_[1][1][0], p[1][0][0], p[1][1][0]*p_[1][0][0], p[1][1][0]*p_[1][1][0], p[1][1][0], p_[1][0][0], p_[1][1][0], 1,
		p[2][0][0]*p_[2][0][0], p[2][0][0]*p_[2][1][0], p[2][0][0], p[2][1][0]*p_[2][0][0], p[2][1][0]*p_[2][1][0], p[2][1][0], p_[2][0][0], p_[2][1][0], 1,
		p[3][0][0]*p_[3][0][0], p[3][0][0]*p_[3][1][0], p[3][0][0], p[3][1][0]*p_[3][0][0], p[3][1][0]*p_[3][1][0], p[3][1][0], p_[3][0][0], p_[3][1][0], 1,
		p[4][0][0]*p_[4][0][0], p[4][0][0]*p_[4][1][0], p[4][0][0], p[4][1][0]*p_[4][0][0], p[4][1][0]*p_[4][1][0], p[4][1][0], p_[4][0][0], p_[4][1][0], 1,
		p[5][0][0]*p_[5][0][0], p[5][0][0]*p_[5][1][0], p[5][0][0], p[5][1][0]*p_[5][0][0], p[5][1][0]*p_[5][1][0], p[5][1][0], p_[5][0][0], p_[5][1][0], 1,
		p[6][0][0]*p_[6][0][0], p[6][0][0]*p_[6][1][0], p[6][0][0], p[6][1][0]*p_[6][0][0], p[6][1][0]*p_[6][1][0], p[6][1][0], p_[6][0][0], p_[6][1][0], 1,
		p[7][0][0]*p_[7][0][0], p[7][0][0]*p_[7][1][0], p[7][0][0], p[7][1][0]*p_[7][0][0], p[7][1][0]*p_[7][1][0], p[7][1][0], p_[7][0][0], p_[7][1][0], 1,
	});
