...
int main()
{
	...
	algebra::MatrixData C = algebra::MatrixMultiplayer::multiply(&A, &B, false, false);
	...
	algebra::MatrixData D = algebra::MatrixMultiplayer::multiply(&A, &B, true, true);
	...
	algebra::MatrixData E = algebra::MatrixMultiplayer::multiply(&A, &B, false, true);
